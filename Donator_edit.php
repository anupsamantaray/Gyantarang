...
<div class="container" id="mcol"><br />
	<div class="row">
		<?php 
		$sql = "SELECT * FROM donaters where Id=".$_GET["id"]."";
		...
		if ($result->num_rows > 0) {
			...
			<div class="col-sm-6" style="padding-bottom:30px;">
				<div class="center1">
					...
					<h4 class="border1"><span>&nbsp;&nbsp;Donaters-</span>&nbsp;<span>Information</span></h4>
				</div>
				<div class="col-sm-6">
			...
			<div class="col-sm-6" style="padding-bottom:30px;">
				<div class="center1">
					...
					<h4 class="border1">Update<span>&nbsp;&nbsp;Donaters-</span>&nbsp;<span>Information</span></h4>
				</div> 
				<div class="ourcenter1">
					<div class="row"> 
						<form id="uploadimage" name="uploadimage" action="" method="post" enctype="multipart/form-data">
							<div class="col-md-6">
								<br />
								<input type="text" name="Sname" class="form-control" value="<?php  echo $row["Dname"] ?>" placeholder = "Student Name">
								<br />
								...
								<a href="edit/delete.php?name=donator&id=<?php  echo $row['Id'] ?>"><input type="button" class="btn btn-success" value="Delete" onclick="validate()"></a>
							</div>
						</form>  
					</div>
				</div>
...
$(document).ready(function (e) {
	$("#uploadimage").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
		url: "edit/donator.php", // Url to which the request is send
