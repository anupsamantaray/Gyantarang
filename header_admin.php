    ...
    <div class="container">
		<div class="row">  
			<div class="col-md-8"> 
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="nav navbar-nav ">
						<li  class="header act_abt"><a href="donatersadd.php">Home</a></li>
						<li class="header act_work"><a href="Donator_admin.php" >Donator</a></li>
						<li class="header act_scho"><a href="Scholarship_admin.php" >Scholarship</a></li>
						<li class="header act_cont"><a href="logout.php">Logout</a></li>
					</ul>
				</div>
			</div>
			<div class="col-sm-2 col-sm-offset-2">
				<div id="sonarmenu">
					<span>
						<a href="#s"><img src="images/facebook.png" /></a></span> <span><a href="#s"><img src="images/twitter.png"  /></a></span> <span><a href="#s"><img src="images/google-plus.png" /></a>
					</span>
				  </div>     
			</div>
		</div>  
